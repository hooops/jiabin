...
class signal_change(models.Model):
    id =  models.AutoField(primary_key=True,max_length=11)
    list_id = models.CharField(max_length=1000,blank=True)
    list_username = models.CharField(max_length=1000,blank=True)
    list_cat_event_id = models.CharField(max_length=1000,blank=True)

    class Meta:
        managed = False
        db_table='signal_change'
class jiabin_event(models.Model):
    id =  models.AutoField(primary_key=True,max_length=11)
    all_event = models.IntegerField(blank=True,max_length=11 )
    class Meta:
        managed = False
        db_table='jiabin_all_event'
...
class jiabin_m(models.Model):
    ...
    username = models.CharField(u'嘉宾名称',max_length=3000,blank=True)
    introduce = models.CharField(u'嘉宾简介',max_length=3000,blank=True)
    homeurl = models.CharField(u'活动家对应链接',max_length=3000,blank=True)
    baikeURL = models.CharField(u'百科对应链接',max_length=3000,blank=True)
    cat_event_id = models.IntegerField(u'活动id',blank=True,max_length=11 )
    jiabin_id=models.ForeignKey(NewEventTable,to_field='old_event_id',blank=True,null=True,verbose_name='关联活动')
    cat= models.IntegerField(u'类别',blank=True,max_length=11 )
    title  = models.CharField(u'活动标题',max_length=3000,blank=True)
    begin_time=models.DateTimeField(u'活动开始时间',blank=True)
    end_time=models.DateTimeField(u'活动结束时间',blank=True)
    recommend= models.IntegerField(u'是否推荐(1推荐)',blank=True,max_length=11,choices=ct,default=0)
    company  = models.CharField(u'公司名称',max_length=3000,blank=True)
    position  = models.CharField(u'所属职位',max_length=3000,blank=True)
    picurl  = models.CharField(u'图片(不填，自动的)',max_length=300,blank=True)
...
class jiabinc(models.Model):
    id =  models.AutoField(primary_key=True,max_length=11)
    imgs = models.ImageField(u'图片文件',upload_to = 'temp',blank=True,null=True)
    username = models.CharField(max_length=3000,blank=True)
    introduce = models.CharField(max_length=3000,blank=True)
    homeurl = models.CharField(max_length=3000,blank=True)
    baikeURL = models.CharField(max_length=3000,blank=True)
    cat_event_id = models.IntegerField(blank=True,max_length=11 )
    jiabin_id=models.ForeignKey(NewEventTable,blank=True,null=True,verbose_name='关联活动')
...
class jiabin_wait(models.Model):
    id =  models.AutoField(primary_key=True,max_length=11)
    imgs = models.ImageField(u'图片文件',upload_to = 'temp',blank=True,null=True)
    username = models.CharField(max_length=3000,blank=True)
    introduce = models.CharField(max_length=3000,blank=True)
    ...
    cat_event_id = models.IntegerField(blank=True,max_length=11 )
    jiabin_id=models.ForeignKey(NewEventTable,blank=True,null=True,verbose_name='关联活动')
    id =  models.IntegerField(max_length=11,blank=True)
...
class NewOrder(models.Model):
    ...
    order_package = models.CharField(u'订单组号',max_length=20, blank=True)
